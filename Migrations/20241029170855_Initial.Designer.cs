...
namespace FeedBackBoardApi.Migrations
{
    ...
    [Migration("20241029170855_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FeedBackBoardApi.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FeedBackBoardApi.Entities.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FeedBackBoardApi.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("FeedBackBoardApi.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FeedBackBoardApi.Entities.Feedback", b =>
                {
                    b.HasOne("FeedBackBoardApi.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FeedBackBoardApi.Entities.Vote", b =>
                {
                    ...
                    b.HasOne("FeedBackBoardApi.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
